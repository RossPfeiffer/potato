...
var insistTX = require("./tx-insist.js")
...
//Polygon Contracts
var potatoNFT_Address = NETWORK?'0x3963B4b48529c990EF8FC4882f2C03b83b3B91e2':'0xcb8ceea2129ee79fdde35c7d3bc3aa88659aa99f'//
...
function mintBatch(){
	...
	client.query(query,function(err,res,fields){
		...
		client.query('SELECT *,ROW_NUMBER() OVER (ORDER BY rarity DESC) AS rare FROM potatoes WHERE '+(function(){
			...
			insistTX(()=>{
				return potatoNFT_Contract.methods.mintPotatoHeads(background, leftArm,rightArm, hat, ears, eyes, nose, mouth,shoes,rarityrank,gradeBonus)
			},()=>{
